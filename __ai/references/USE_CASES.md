...
- Rows 12–13: signer verified as Chairman where possible, never generated by the executor, and a later threshold change does not retroactively alter an existing voting. Unit and base come from the contract.
